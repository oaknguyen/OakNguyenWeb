    ...
    var loadLocal = function() {
        ...
        if(videoOptions.localFiles.mp4.length) {
            ...
            var flashTemplate = '<object class="fillWidth">' +
                                    '<param name="movie" value="inc/StrobeMediaPlayback.swf"></param>' +
                                    ...
                                    '<embed class="fillWidth" src="inc/StrobeMediaPlayback.swf" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" wmode="opaque" flashvars="src={file}&loop=true&autoPlay=true&playButtonOverlay=false&scaleMode=zoom&controlBarMode=none&volume={volume}&bufferingOverlay=false&poster={poster}"></embed>' +
                                '</object>';
